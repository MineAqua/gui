...
public final class PaginatedMenuUtils {

    private PaginatedMenuUtils() {
        throw new UnsupportedOperationException();
    }

    public static <E> Inventory createPage(Inventory delegate,
    ...
    private static ItemClickable getInteractPageItem(boolean expression, int currentPage, int newPage,
                                                     int currentSlot,
        ...
        if (expression) {
            itemClickable = pageItem.apply(currentPage)
                    .clone(currentSlot)
                    .clone(ItemClickableAction.globalAction(inventory -> {
